	...
	<div class="row">
		...
		<div class="card">
			...
			<p>The Ministry has been administering ‘Support to Training and
				...
				as spoken English, Gems & Jewellery, Travel & Tourism, Hospitality.</p>
			<br>
			<h3>STEP Guidelines</h3>
			<p>
			<ol style="type: 1">
				<li>All women who are in the age group of 16 years and above</li>
				<li>In this scheme the beneficiaries will be registered under
					an NGO, that will be providing the training and employment
					programme.</li>
				<li>Women who are under training are provided accommodation
					only under the condition that that there is vacancy available after
